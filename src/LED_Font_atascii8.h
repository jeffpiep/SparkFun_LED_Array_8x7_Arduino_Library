...
static const unsigned char c_ga[] PROGMEM = {	8	,	0, 24 , 60 , 126 , 126 , 60 , 24,0 	};
...
static const unsigned char c_oc[] PROGMEM = {   8  , 0,24 , 92 , 126 , 126 , 92 , 24,0 };
static const unsigned char c_vb[] PROGMEM = {   8 , 0,0,0,127, 127 ,0,0,0};
static const unsigned char c_cc[] PROGMEM = { 8  , 0, 62 , 62, 14, 30, 122, 114,0 };
